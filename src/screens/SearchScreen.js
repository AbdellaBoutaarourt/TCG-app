...
const categories = [
    ...
    {
        name: "Boîtes à burger", icon: <Svg width="26" height="16" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        name: "Emballages pour kapsalon", icon: <Svg width="26" height="16" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: "Papiers et films alimentaires", icon: "filmstrip" },
