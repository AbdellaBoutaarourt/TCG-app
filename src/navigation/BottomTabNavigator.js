...
const BottomTabNavigator = () => {
    return (
        ...
        >
            ...
            <Tab.Screen name="Favoris" component={FavoritesScreen} options={{ headerTitleStyle: { fontFamily: "InterBold" } }} />
            <Tab.Screen name="Panier" component={CartScreen} options={{ headerTitleStyle: { fontFamily: "InterBold" } }} />
